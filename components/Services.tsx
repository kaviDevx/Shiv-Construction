  ...
  const services = [
    {
      ...
      description: 'Custom homes, renovations, and residential projects built to your specifications with attention to detail.',
      icon: (
    ...
    },
    {
      ...
      description: 'Comprehensive project management ensuring timely completion and quality delivery.',
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: 'Creative architectural solutions that blend aesthetics with functionality.',
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: 'Rigorous quality control and inspection processes to ensure excellence in every project.',
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
